    ...
    await (async () => {
      {
        ...
        const description = legacyState?.querySelector(
          '.empty-state-description',
        );

        assert.ok(
          title,
          'Expected the legacy state to expose a labelled title',
        );
        assert.ok(
          description,
            ...
            <ThemeProvider theme={defaultTheme}>
              <EmptyState
                ...
                description={
                  <>
                    <p>
                      Add the first threat to start tracking the assessment.
                    </p>
                    <p>
                      The layout should still read cleanly on narrow screens.
                    </p>
                  </>
                }
                primaryAction={<Button title="Add threat" />}
          ...
          root.render(
            <ThemeProvider theme={defaultTheme}>
              <EmptyState
                ...
                primaryAction={
                  <Button title="Clear filters" variant="secondary" />
                }
              />
            </ThemeProvider>,
          );
...

      {
        ...
        assert.ok(
          unavailableState,
          'Expected the unavailable variant to render',
        );
