    ...
    await (async () => {
      {
        ...
        ).find(button => button.textContent?.includes('Retry')) as
          | HTMLButtonElement
          | undefined;
          ...
          const markup = renderToString(
            sheet.collectStyles(
              <ThemeProvider theme={defaultTheme}>
                ...
                >
                  <p>
                    This message is intentionally long so the stylesheet keeps
                    the body and action layout readable on narrow screens and
                    allows the text to wrap instead of overflowing the
                    container.
                  </p>
                  <p>
                    Additional text should continue to wrap cleanly across
                    mobile widths.
                  </p>
                </Callout>
              </ThemeProvider>,
