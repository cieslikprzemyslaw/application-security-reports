...
await (async () => {
  {
    ...
    const activeHeader = container.querySelector('th[aria-sort="ascending"]');
    assert.ok(
      activeHeader,
...

  {
    ...
    const activeHeader = container.querySelector('th[aria-sort="descending"]');
    assert.ok(
      activeHeader,
...

  {
    ...
    for (const header of inactiveHeaders) {
      ...
      assert.ok(
        iconSpan?.classList.contains('assessment-table__sort-icon--inactive'),
...

  {
    ...
    const svgs = container.querySelectorAll('.assessment-table__sort-icon svg');
